...
item_table: Dict[str, AWItemData] = {
    ...
    iname.fanny_pack.value: AWItemData(IClass.useful, 1, 13, "Toys"),
    ...
    iname.egg_65.value: AWItemData(IClass.progression_skip_balancing, 1, 91),  # put back in eggs group in 0.5.0
