...
starts = {
    ...
    "stag_nest": {
        "logic_name": "Stag Nest",
        "granted_transition": "Cliffs_03[right1]",
        "logic": []
    },
    "west_crossroads": {
        "logic_name": "West Crossroads",
        "granted_transition": "Crossroads_36[right1]",
        "logic": []
    },
    "east_crossroads": {
        "logic_name": "East Crossroads",
        "granted_transition": "Crossroads_03[top1]",
        "logic": []
    },
    "ancestral_mound": {
        "logic_name": "Ancestral Mound",
        "granted_transition": "Crossroads_ShamanTemple[left1]",
        "logic": []
    },
    "west_fog_canyon": {
        "logic_name": "West Fog Canyon",
        "granted_transition": "Fungus3_30[bot1]",
        "logic": []
    },
    "east_fog_canyon": {
        "logic_name": "East Fog Canyon",
    ...
    "fungal_wastes": {
        "logic_name": "Fungal Wastes",
        "granted_transition": "Fungus2_28[left1]",
        "logic": []
    },
    "greenpath": {
        "logic_name": "Greenpath",
        "granted_transition": "Fungus1_32[left1]",
        "logic": []
    },
    "lower_greenpath": {
        "logic_name": "Lower Greenpath",
        "granted_transition": "Fungus1_13[right1]",
        "logic": []
    },
    "west_blue_lake": {
        "logic_name": "West Blue Lake",
        "granted_transition": "Crossroads_50[left1]",
        "logic": []
    },
    "east_blue_lake": {
        "logic_name": "East Blue Lake",
        "granted_transition": "Crossroads_50[right1]",
        "logic": [
            {
                "item_requirements": [
                    "ITEMRANDO",
    ...
    "outside_colosseum": {
        "logic_name": "Outside Colosseum",
        "granted_transition": "Deepnest_East_09[right1]",
        "logic": []
    },
    "crystallized_mound": {
        "logic_name": "Crystallized Mound",
        "granted_transition": "Mines_35[left1]",
        "logic": []
    },
    "mantis_village": {
        "logic_name": "Mantis Village",
        "granted_transition": "Fungus2_14[right1]",
        "logic": [
            {
                "item_requirements": [
                    "ITEMRANDO",
    ...
    "west_waterways": {
        "logic_name": "West Waterways",
        "granted_transition": "Waterways_09[left1]",
        "logic": [
            {
                "item_requirements": [
                    "ITEMRANDO",
    ...
    "distant_village": {
        "logic_name": "Distant Village",
        "granted_transition": "Room_spider_small[left1]",
        "logic": [
            {
                "item_requirements": [
                    "FULLAREARANDO"
    ...
    "far_greenpath": {
        "logic_name": "Far Greenpath",
        "granted_transition": "Fungus1_13[left1]",
        "logic": [
            {
                "item_requirements": [
                    "MAPAREARANDO"
    ...
    "hive": {
        "logic_name": "Hive",
        "granted_transition": "Hive_03[right1]",
        "logic": [
            {
                "item_requirements": [
                    "ROOMRANDO"
    ...
    "royal_waterways": {
        "logic_name": "Royal Waterways",
        "granted_transition": "Waterways_03[left1]",
        "logic": [
            {
                "item_requirements": [
                    "ROOMRANDO"
    ...
    "city_of_tears": {
        "logic_name": "City of Tears",
        "granted_transition": "Ruins1_27[left1]",
        "logic": [
            {
                "item_requirements": [
                    "ROOMRANDO"
    ...
    "abyss": {
        "logic_name": "Abyss",
        "granted_transition": "Abyss_06_Core[right2]",
        "logic": [
            {
                "item_requirements": [
                    "ROOMRANDO"
    ...
    "fungal_core": {
        "logic_name": "Fungal Core",
        "granted_transition": "Fungus2_30[top1]",
        "logic": [
            {
                "item_requirements": [
                    "ROOMRANDO"
